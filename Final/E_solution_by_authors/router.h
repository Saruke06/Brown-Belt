...
namespace Graph {
  ...
  public:
    ...
    auto BuildRoute(VertexId from, VertexId to) const -> std::optional<RouteInfo>;
    auto GetRouteEdge(RouteId route_id, size_t edge_idx) const -> EdgeId;
  ...
  template <typename Weight>
  auto Router<Weight>::BuildRoute(VertexId from, VertexId to) const -> std::optional<typename Router<Weight>::RouteInfo>
  {
  ...
  template <typename Weight>
  auto Router<Weight>::GetRouteEdge(RouteId route_id, size_t edge_idx) const -> EdgeId
  {
