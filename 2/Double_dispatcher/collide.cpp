...
public:
  ...
  const geo2d::Point& GetElement() const {
	  return pos;
  }
...
public:
  ...
  const geo2d::Rectangle& GetElement() const {
	  return rec;
  }
...
public:
  ...
  const geo2d::Circle& GetElement() const {
	  return circle;
  }
...
public:
  ...
  const geo2d::Segment& GetElement() const {
	  return seg;
  }
...
bool Unit::CollideWith(const Unit& that) const {
	return geo2d::Collide(pos, that.GetElement());
}
...
bool Building::CollideWith(const Unit& that) const {
	return geo2d::Collide(rec, that.GetElement());
}
...
bool Tower::CollideWith(const Unit& that) const {
	return geo2d::Collide(circle, that.GetElement());
}
...
bool Fence::CollideWith(const Unit& that) const {
	return geo2d::Collide(seg, that.GetElement());
}
